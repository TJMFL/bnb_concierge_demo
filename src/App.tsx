        ...
        >
          <div className="flex flex-col h-full">
            <div className="p-4 border-b border-gray-200">
              ...
              Powered by <span className="font-bold text-purple-800">ENSPYR AI</span>
              </p>
            </div>
            ...
            <nav className="flex-1 p-4 space-y-1">
              <Link
                to="/"
                className="flex items-center px-3 py-2 text-purple-800 rounded-md hover:bg-gray-100 hover:text-blue-600 transition-colors"
